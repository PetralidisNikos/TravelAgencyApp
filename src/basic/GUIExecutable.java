...
//---------------------GUI stuff here-----------------------------------------------------------------
		...
		JLabel lblNewLabel_1 = new JLabel("Enter your credentials");
		...
		JLabel lblNewLabel_4 = new JLabel("Fill the criteria according to your liking:");
		lblNewLabel_4.setEnabled(false);

		JLabel lblNewLabel_5 = new JLabel("Museums:");
		lblNewLabel_5.setEnabled(false);

		JLabel lblNewLabel_6 = new JLabel("Bars:");
		lblNewLabel_6.setEnabled(false);

		JLabel lblNewLabel_7 = new JLabel("Cafeterias:");
		lblNewLabel_7.setEnabled(false);

		JLabel lblNewLabel_8 = new JLabel("Restaurants:");
		lblNewLabel_8.setEnabled(false);

		JLabel lblNewLabel_9 = new JLabel("Beaches:");
		...
		JLabel lblNewLabel_10 = new JLabel("Current Latitude:");
		lblNewLabel_10.setEnabled(false);

		JLabel lblNewLabel_11 = new JLabel("Current Longitude:");
		...
		JCheckBox chckbxNewCheckBox = new JCheckBox("Exclude cities currently raining");
		...
		JLabel lblNewLabel_15 = new JLabel("-Example: Athens,GR");
		lblNewLabel_15.setEnabled(false);
		lblNewLabel_15.setFont(new Font("Tahoma", Font.ITALIC, 10));

		JButton btnNewButton_3 = new JButton("Finalize");
		...
		JLabel lblNewLabel_13 = new JLabel("result is displayed here");
		...
		JLabel lblNewLabel_16 = new JLabel("Wrong(lat,lon) input, Try Again");
		...
		JLabel lblNewLabel_17 = new JLabel("Wrong input format, try again");
		lblNewLabel_17.setForeground(Color.RED);
		lblNewLabel_17.setVisible(false);
		
		JLabel lblNewLabel_18 = new JLabel("One of the cities you enetered was not found");
		lblNewLabel_18.setForeground(Color.RED);
		lblNewLabel_18.setVisible(false);
		
		JLabel lblNewLabel_19 = new JLabel("Dont leave the name field blank");
